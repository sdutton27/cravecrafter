    ...
    return (
        <div style={{ position: "relative", width: '100%', display: "flex", flexDirection: "column" }}>
            ...
            <div style={{
                ...
                flexDirection: "column", alignItems: "center", alignSelf: "center", marginTop: "35vh"
            }}>
                {/* <h1 style={{
                    textAlign: 'center', color: '#FCFBFA', fontSize: 104,
                ...
                <h3 style={{
                    color: '#FCFBFA', fontSize: 24, fontFamily: 'Epilogue',
                    fontWeight: '400', wordWrap: 'break-word', lineHeight: 2,
                }}>
                    Let us do the decision making for you.
                </h3>
                <SurpriseOrderButton />
            </div>
            <img src={heroImage} style={{ filter: 'brightness(40%)', position: "relative", objectFit: "cover", height: "75vh" }} alt="food" />
            {/* What We Offer Section */}
            <div id="about" style={{ width: '100%', height: '100%', paddingTop: 160, paddingBottom: 160, background: '#F7F7F7', alignItems: 'center', justifyContent:"center", display: "flex", flexDirection: "column"}}>
