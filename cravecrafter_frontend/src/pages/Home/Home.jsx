...
export default function Home() {
    return (
        <div style={{ position: "relative", width: '100%', display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ width: '100%', height: '100%', paddingTop: 160, paddingBottom: 160, background: '#F7F7F7', alignItems: 'center', justifyContent:"center", display: "flex", flexDirection: "column"}}>
