    ...
    <div className="bg-gray-200 min-h-screen flex items-center justify-center">
      ...
      <div className="relative bg-white shadow-md p-6 rounded-lg w-1224 h-976">
        ...
        <div className="mx-auto my-8 w-[90%] h-64 bg-gray-300 rounded-xl">
          ...
          <iframe className="rounded-lg" width="563" height="256" frameborder="0" marginheight="0" marginwidth="0" id="gmap_canvas" src="https://maps.google.com/maps?width=563&amp;height=256&amp;hl=en&amp;q=2200%20212TH%20ST%20OSKALOOSA+(CraveCrafter)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> <a href='https://www.acadoo.de/'></a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=5b5ea4aec97b020cbf3b8a39ec1d67ee007fe5b1'></script>
        </div>
