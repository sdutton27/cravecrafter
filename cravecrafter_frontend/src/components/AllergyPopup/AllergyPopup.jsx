...
export default function AllergyPopup(props) {
    ...
    //     console.log("changing vegetarian")
    //   }
          ...
          <ClickAwayListener onClickAway={handleClickAway}>
            ...
            <div className="w-80 h-84 shadow-2xl rounded-xl bg-white flex flex-col justify-content items-center epilogue">
              ...
              <div className="grid grid-cols-2 gap-x-10 mt-2">
                {/* Vegetarian */}
                <div>
                  <Checkbox aria-label="Demo input" 
                  />
              ...
              <Input aria-label="Demo input" placeholder="" className="text-sm font-light" style={{border: "1px solid #434D5B"}}>
              </Input>
              </div>
            </div>
          </ClickAwayListener>
