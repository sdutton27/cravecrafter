  ...
  return (
    <div className="bg-[#7a7a7a] min-h-screen flex items-center justify-center">
      ...
      <div className="bg-white shadow-2xl p-4 rounded-xl">
        ...
        {/* Subtitle */}
        <p className="text-[#050312] text-sm mb-6">Please specify a few details, and we’ll place a surprise order from one of your favorite restaurants. title</p>
        ...
        <div className="flex">
          <span className="text-[#050312] text-sm text-semibold">$</span>
        </div>
        <div className="flex">
          <span className="text-[#050312] text-sm text-semibold">$$</span>
        </div>
        <div className="flex">
          <span className="text-[#050312] text-sm text-bold">$$$</span>
        </div>
